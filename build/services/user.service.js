...
var UserService = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user.isActive = true;
                        return [4 /*yield*/, this.repository.update(user.id, user)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UserService.prototype.getKulteur = function () {
        return this.repository.find({ where: { role: user_entity_1.UserRole.KULTEUR } });
    };
    return UserService;
